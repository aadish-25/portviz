...
It aims to simplify debugging scenarios like “Address already in use” errors by providing structured, readable port information and streamlined process control.
...
PortViz is being built in phases:

Core cross-platform port inspection engine (Python)

CLI utility for quick terminal usage

VSCode extension for in-editor visibility and control


The long-term goal is to create a reusable, modular developer utility that integrates seamlessly into modern development workflows.
...
“Port already in use” errors disrupt workflow
...
PortViz is structured in layers:
...
This modular architecture allows the engine to be reused across CLI tools and IDE integrations.
